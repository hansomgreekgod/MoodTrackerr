...
import com.jakkie.android.moodtrackerr.adapter.IntroViewPagerAdapter;
import com.jakkie.android.moodtrackerr.util.ScreenItem;

import java.util.ArrayList;
import java.util.List;

/**
 * Structure of the Introduction screens.
 */
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("MoodTrackerr App", "5 Moods to choose everyday.", R.drawable.web_hi_res_512));
